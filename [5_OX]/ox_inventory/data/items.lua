return {
	...
	['bmx'] = {
		label = 'BMX',
		weight = 5000, -- Poids de l'item
		stack = false, -- Uniquement un par slot
		close = true, -- Fermer l'inventaire après utilisation
		description = 'Utilisez cet item pour obtenir un BMX',
		client = {
			event = 'bmx:useItem', -- L'événement déclenché
		},
	},
